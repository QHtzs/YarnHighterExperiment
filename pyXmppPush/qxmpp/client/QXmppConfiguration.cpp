 ...
 *
 * 对config加入了 QSslConfiguration， 便于双向验证等需求
 */
...
QSslConfiguration QXmppConfiguration::sslconfig() const
{
    return d->ssl_conf;
}

void QXmppConfiguration::setSslConfiguration(const QSslConfiguration &cf)
{
    d->ssl_conf = cf;
}
